	...
	<section id="projetos">
		<div class="w-full h-full flex flex-col gap-y-16 justify-center items-center bg-black px-5 py-28 rounded-t-[80px]">
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 grid-rows-3 gap-5">
				<div class="sm:row-span-2 w-full max-w-[18rem] h-full bg-neutral-900 rounded-[50px] thales-dev-image bg-cover bg-center overflow-hidden">
			...
			<div>
				<a href="https://wa.me/message/LKGVV4OYMYBYO1" target="_blank" class="text-black font-montserrat font-bold bg-white rounded-3xl px-6 py-2.5">Veja todos os projetos</a>
			</div>
		</div>
	</section>
</template>
