		...
		<div class="w-full h-full flex flex-col-reverse md:flex-row gap-y-5 justify-center items-center px-28 pt-40 md:pt-52 pb-28 md:pb-36">
			<div class="space-y-5">
				...
				<div class="flex justify-center md:justify-start">
					<a href="https://wa.me/message/LKGVV4OYMYBYO1" target="_blank" class="mt-1 block text-black font-montserrat font-bold bg-[#00ff7b] rounded-3xl px-6 py-2.5 whitespace-nowrap">Entre em contato</a>
				</div>
			</div>
			<div>
