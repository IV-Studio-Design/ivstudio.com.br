		...
		<div class="w-full h-full flex gap-x-16 justify-center items-center py-10">
			...
			<div class="space-y-7 mt-10">
				...
				<div class="flex justify-center md:justify-start items-center">
					<a href="https://wa.me/message/LKGVV4OYMYBYO1" target="_blank" class="block text-black font-montserrat font-bold bg-white rounded-3xl px-6 py-2.5">Fale conosco!</a>
				</div>
			</div>
		</div>
	</section>
